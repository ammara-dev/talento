    ...
    dashboard: {
      cards: [
        ...
        },
        {
          title: 'Cash account',
          subtitle: 'Name - HO',
          sparkline: { path: 'M0 22 C55 42, 100 40, 150 28 C205 16, 238 42, 320 32', color: '#AB273B', markerX: 255 },
          balanceLabel: '',
        ...
        },
        {
          ...
          sparkline: { path: 'M0 22 C50 42, 96 44, 140 26 C186 10, 224 40, 270 34 C295 30, 306 34, 320 33', color: '#BEBBC4', markerX: 280 },
          balanceLabel: '',
          balance: '-12,226.00 SAR',
          viewLabel: 'View',
          addLabel: 'Add new'
        },
        {
          ...
          sparkline: { path: 'M0 26 C70 34, 112 54, 150 58 C180 60, 206 42, 236 46 C262 49, 285 62, 320 56', color: '#C3C0C9', markerX: 275 },
          balanceLabel: '',
