...
(function() {
  ...
  const pageConfig = {
    ...
    'attendance-scan-badge.html': { navItem: 'attendance-leave', submenu: 'attendance' },
    ...
    'accounting-dashboard-checklist-screen.html': { navItem: 'finance', submenu: 'accounting' },
    ...
    <div id="sb-scroll">
      <nav style="display:flex;flex-direction:column;padding:4px 0;">
        ...
        <div id="attendance-submenu" style="display:${isAttendanceExpanded ? 'flex' : 'none'};flex-direction:column;">
          <!-- Attendance sub-link -->
          <a href="attendance-scan-badge.html" style="text-decoration:none;">
